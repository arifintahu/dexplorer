      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {proposal.finalTallyResult && (
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                <span style={{ color: colors.text.secondary }}>Yes Votes:</span>
                <span style={{ color: colors.status.success }}>
                  {proposal.finalTallyResult.yesCount}
                </span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: colors.text.secondary }}>No Votes:</span>
                <span style={{ color: colors.status.error }}>
                  {proposal.finalTallyResult.noCount}
                </span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: colors.text.secondary }}>Abstain Votes:</span>
                <span style={{ color: colors.text.tertiary }}>
                  {proposal.finalTallyResult.abstainCount}
                </span>
              </div>
              <div className="flex justify-between">
                <span style={{ color: colors.text.secondary }}>No With Veto:</span>
